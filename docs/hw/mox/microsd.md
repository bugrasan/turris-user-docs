Preparing microSD card for Turris MOX
======================================
...
6](mox_rescue_modes.md#flash-from-the-internet) when starting the
...
mode number 4](mox_rescue_modes.md#re-flash-router) to reformat
your MicroSD card.
